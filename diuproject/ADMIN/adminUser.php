...
<div id="main">
    ...
    <div>
        <button class="btn btn-lg btn-info mt-5 ml-3" data-toggle="modal" data-target=".modal">Add New Admin
        </button>
    </div>
                    ...
                    <table class="table table-striped table-bordered table-responsive-sm ">
                        ...
                        while ($rowAdminAccount = mysqli_fetch_array($queryAdminAccount)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="adminEdit.php?uid=<?php echo $rowAdminAccount['id']; ?>"
                                       class="btn btn-info">
                                        </i>Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="Delete/adminDelete.php?uid=<?php echo $rowAdminAccount['id']; ?>"
