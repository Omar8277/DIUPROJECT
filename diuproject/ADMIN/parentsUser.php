...
?>
<?php
class parentUserClass{
    function parentUserFunction(){
        ...
        if (isset($_POST['submitNewUserAdmin'])) {
            ...
            $sqliAddNewUser = "INSERT INTO prentice_account(firstname,lastname,username,mobile,email,password) 
...
$parentUserObject = new parentUserClass();
$parentUserObject->parentUserFunction();
?>
<!doctype html>
<html lang="en">
<head>
...
<div id="main">
    ...
    <div>
        <button class="btn btn-lg btn-info mt-5 ml-3" data-toggle="modal" data-target=".modal">Add New Parent
        </button>
    </div>
                    ...
                    <table class="table table-striped table-bordered table-responsive-sm ">
                        ...
                        while ($rowAdminAccount = mysqli_fetch_array($queryAdminAccount)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="parantsEdit.php?uid=<?php echo $rowAdminAccount['id']; ?>"
                                       class="btn btn-info">
                                        </i>Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="Delete/prenticeDelete.php?uid=<?php echo $rowAdminAccount['id']; ?>"
