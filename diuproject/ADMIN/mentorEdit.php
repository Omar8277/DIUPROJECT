...
if (isset($_POST['mentorEditSumit'])){
    ...
    $mobile = $_POST['mobile'];
    $email = $_POST['email'];
    $sqlEdit = "UPDATE mentor_account SET firstname='$firstname', lastname='$lastname', mobile='$mobile', email ='$email' WHERE id='$id'  ";
...
?>
<?php
$sql = "SELECT * FROM mentor_account WHERE id =$id LIMIT 1 ";
