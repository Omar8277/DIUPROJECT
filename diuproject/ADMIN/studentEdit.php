...
if (isset($_POST['studentEditSumit'])){
    ...
    $mobile = $_POST['mobile'];
    $email = $_POST['email'];
    $sqlEdit = "UPDATE student_account SET firstname='$firstname', lastname='$lastname', mobile='$mobile', email ='$email' WHERE id='$id'  ";
            ...
            <form method="post" action="">
                <div class="modal-body">
                    ...
                    <div class="modal-footer bg-fade">
                        <input type="submit" name="studentEditSumit"  class="btn btn-lg bg-success" >
                    </div>
            </form>
        </div>
    </div>
