...
class mentorUserClass{
    function mentorUserFunction(){
        if (isset($_POST['submitNewUserAdmin'])) {
            ...
            $sqliAddNewUser = "INSERT INTO mentor_account(firstname,lastname,username,mobile,email,password) 
VALUES('$firstname','$lastname','$username','$mobile','$email',md5('$password'))";
...
class mentorUserInheritance extends mentorUserClass {


}


$mentorUserObject = new mentorUserInheritance();
$mentorUserObject->mentorUserFunction();
?>
<!doctype html>
<html lang="en">
<head>
...
<div id="main">
    ...
    <div>
        <button class="btn btn-lg btn-info mt-5 ml-3" data-toggle="modal" data-target=".modal">Add New Monter
        </button>
    </div>
                ...
                <div class="card ">
                    <div class="card-header bg-info ">
                        <h4 class="latest-post text-white">
                            <i class="mr-2 fas fa-chalkboard-teacher">
                            </i>Mentor Users Account
                        </h4>
                    </div>
                    <table class="table table-striped table-bordered table-responsive-sm ">
                        ...
                        while ($rowMentorAccount = mysqli_fetch_array($queryMentorAccount)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="mentorEdit.php?uid=<?php echo $rowMentorAccount['id']; ?>"
                                       class="btn btn-info">
                                        </i>Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="Delete/mentorDelete.php?uid=<?php echo $rowMentorAccount['id']; ?>"
