...
if (isset($_POST['mentorSubmit'])) {
    $mentorUsername = $_POST['mentorUsername'];
    $mentorPassword = $_POST['mentorPassword'];
//$_SESSION["mentorUsername"] =$mentorUsername;
    $res = mysqli_query($mysql, "select* from mentor_account where username='$mentorUsername'and password=md5('$mentorPassword')");
    $result = mysqli_fetch_array($res);
    if ($result) {
        $_SESSION['user'] = $mentorUsername;
...
?>
<h1 class="text-center mt-5 text-black-50">Mentor Account
</h1>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 text-center">
                            <h4 class="text-center">Mentor
                            </h4>
                            <img src="../img/diuIcon.png " height="100" width="100">
                        </div>
                        <div class="col-md-8">
                            <form action="" METHOD="POST">
                                <input type="text" class="form-control mb-2" placeholder="Username" name="mentorUsername">
                                <input type="password" class="form-control mb-2" placeholder="Password" name="mentorPassword">
