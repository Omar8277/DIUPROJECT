...
if (isset($_POST['adminEditSumit'])){
    ...
    $course_4= $_POST['course_3'];
    $course_5= $_POST['course_5'];
    $sqlEdit = "UPDATE student_account SET course_1='$course_1', course_2='$course_2',course_3='$course_3', course_4='$course_4',course_5='$course_5' WHERE id='$id'  ";
            ...
            <form method="post" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="course_1" class="form-control"   value="<?php echo $row['course_1'];?> ">
                    </div>
                    <div class="form-group">
                        <label>Subject 2
                        </label>
                        <input type="text"  name="course_2" class="form-control"   value="<?php echo $row['course_2'];?> ">
                    </div>
                    <div class="form-group">
                        <label>Subject 3
                        </label>
                        <input type="text"  name="course_3" class="form-control"   value="<?php echo $row['course_3'];?> ">
                    </div>
                    <div class="form-group">
                        <label>Subject 4
                        </label>                                           
                        
                        <input type="text"  name="course_4" class="form-control"   value="<?php echo $row['course_4'];?> ">
                    </div>
                        <label>Subject 5
                        </label>                                           
                        
                        <input type="text"  name="course_5" class="form-control"   value="<?php echo $row['course_5'];?> ">
                    </div>
